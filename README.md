...
- **Only 41 of 529 works carry an image, and that is correct.** The source files are Artstor
  ...
  Commons and museum open-access programmes: the first such pass added 16, each verified
  side by side against Optima's own copy before publication.
